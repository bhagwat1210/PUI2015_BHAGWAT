CLARITY : Trip duration could be rendered  in minutes for better clarity or take log scales for seconds if pattern is all we are after , A larger fig size could be incorporated 
